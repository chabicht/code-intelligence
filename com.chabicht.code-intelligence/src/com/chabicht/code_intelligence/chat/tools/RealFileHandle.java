...
/**
 * Implementation of IFileHandle that wraps a real Eclipse IFile. All methods
 * delegate to the underlying IFile instance.
 */
public class RealFileHandle implements IFileHandle {
	...
	public long getLength() {
		try {
			...
			com.chabicht.code_intelligence.util.Log.logWarn("Failed to get file length for: " + file.getFullPath(), e);
		}
		return 0;
	}
