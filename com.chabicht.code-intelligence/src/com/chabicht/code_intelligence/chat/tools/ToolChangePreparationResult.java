...
/**
 * A standard result object for tools that prepare TextEdits for an existing
 * file. This object is stateless and used to transfer prepared changes to the
 * FunctionCallSession.
 */
public class ToolChangePreparationResult {
	...
	private ToolChangePreparationResult(boolean success, String message, IFile file, List<TextEdit> edits,
			String diffPreview) {
	 ...
	 */
	public static ToolChangePreparationResult success(String message, IFile file, List<TextEdit> edits,
			String diffPreview) {
