...
public enum ToolProfile {
	READ_ONLY("Read Only", Set.of("read")), ALL("All Tools", null);
	...
	/**
	 * Returns true if a tool with the given tags is allowed by this profile. A tool
	 * is allowed if at least one of its tags is in the profile's allowed set. If
	 * allowedTags is null (i.e., ALL profile), every tool passes. If the tool has
	 * no tags, it is always allowed (backwards compatibility).
	 */
