...
/**
 * Implementation of IFileHandle for virtual files that don't exist yet. These
 * represent files pending creation with content stored in memory.
 */
public class VirtualFileHandle implements IFileHandle {
	 ...
	 * 
	 * @param fullPath the full workspace-relative path (e.g.,
	 *                 "/Project/src/File.java")
	 * @param content  the file content (must not be null, use empty string for
	 *                 empty file)
